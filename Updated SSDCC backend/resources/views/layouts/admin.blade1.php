...
<head>
    ...
    <title>{{ config('app.name', 'Agent Lynk') }}</title>
...
<!-- 
            ...
            <div class="left-side-menu">
                ...
                <div class="slimscroll-menu">
                    ...
                    @elseif(Auth::user()->user_type =='realtor')   
                         @include('includes.sidebar_realtor')  
                     @elseif(Auth::user()->user_type =='signage')   
                         @include('includes.sidebar_signage')    
                         
                     @elseif(Auth::user()->user_type =='home-inspector')   
                         @include('includes.sidebar_home-inspector')    
                     @elseif(Auth::user()->user_type =='photographer')   
                         @include('includes.sidebar_photographer')                    
