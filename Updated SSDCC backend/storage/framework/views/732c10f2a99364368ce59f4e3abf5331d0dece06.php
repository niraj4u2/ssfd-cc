  ...
  <div class="content">
    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"><?php echo e(Config::get('global.user_type.admin')); ?> </li>
                        </ol>
                    </div>
                    <h4 class="page-title"><?php echo e(Config::get('global.user_type.admin')); ?> List</h4>
                </div>
            </div>
        </div>     
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    <h4 class="header-title"><?php echo e(Config::get('global.user_type.admin')); ?> List</h4>
                         <!-- Alert message (start) -->
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/agent/resources/views/user/admin.blade.php ENDPATH**/ ?>