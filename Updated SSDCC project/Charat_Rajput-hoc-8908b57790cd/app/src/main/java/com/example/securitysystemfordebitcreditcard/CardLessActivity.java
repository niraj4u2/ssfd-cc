...
public class CardLessActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_card_less);
            ...
            public void onClick(View v) {
                ...
                if (isVailid() == true) {
                    ...
                    } else if (current.equals(entered))
                    {
                        ...
                        intent.putExtra("op", "Option 2.");
                        DecimalFormat formatter = new DecimalFormat("#,###,###");
                        long num = Long.parseLong(eTAmount.getText().toString());
                        String yourFormattedString = formatter.format(num);
                        intent.putExtra("msg", "The card will automatically lock-up after one card less transactions of \u20B9 "+yourFormattedString+"/- "+"on ATM or at merchant or at online portal.");
